...
namespace FuerteWpDep\Carbon_Fields\Widget;

use FuerteWpDep\Carbon_Fields\Helper\Helper;
use FuerteWpDep\Carbon_Fields\Container\Container;
 ...
 */
abstract class Widget extends \FuerteWpDep\WP_Widget
{
    ...
    {
        \FuerteWpDep\Carbon_Fields\Carbon_Fields::verify_boot();
        ...
        $widget_options = array('description' => $description, 'classname' => $classname, 'widget_ID' => $widget_id);
    ...
    public function add_fields($fields)
    {
        foreach ($fields as $field) {
            ...
            $field->set_datastore($this->datastore, \true);
        }
