...
use FuerteWpDep\Carbon_Fields\Helper\Color;
if (!\function_exists('FuerteWpDep\\carbon_field_exists')) {
...
if (!\function_exists('FuerteWpDep\\carbon_get')) {
...
if (!\function_exists('FuerteWpDep\\carbon_set')) {
...
if (!\function_exists('FuerteWpDep\\carbon_hex_to_rgba')) {
