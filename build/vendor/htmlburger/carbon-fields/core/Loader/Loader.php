...
namespace FuerteWpDep\Carbon_Fields\Loader;

use FuerteWpDep\Carbon_Fields\Container\Repository as ContainerRepository;
use FuerteWpDep\Carbon_Fields\Exception\Incorrect_Syntax_Exception;
use FuerteWpDep\Carbon_Fields\Helper\Helper;
use FuerteWpDep\Carbon_Fields\Libraries\Sidebar_Manager\Sidebar_Manager;
use FuerteWpDep\Carbon_Fields\Pimple\Container as PimpleContainer;
use FuerteWpDep\Carbon_Fields\Service\Legacy_Storage_Service_v_1_5;
use FuerteWpDep\Carbon_Fields\Service\Meta_Query_Service;
use FuerteWpDep\Carbon_Fields\Service\REST_API_Service;
/**
...
class Loader
{
    ...
    public function boot()
    {
        ...
        include_once \FuerteWpDep\Carbon_Fields\DIR . '/core/functions.php';
        ...
        \FuerteWpDep\Carbon_Fields\Carbon_Fields::service('legacy_storage')->enable();
        # Enable the meta query service
        \FuerteWpDep\Carbon_Fields\Carbon_Fields::service('meta_query')->enable();
        # Enable the REST API service
        \FuerteWpDep\Carbon_Fields\Carbon_Fields::service('rest_api')->enable();
        # Enable post meta revisions service
        \FuerteWpDep\Carbon_Fields\Carbon_Fields::service('revisions')->enable();
    ...
    {
        $dir = \FuerteWpDep\Carbon_Fields\DIR . '/languages/';
    ...
    protected function enqueue_style($src, $deps = array())
    {
        ...
        wp_enqueue_style('carbon-fields-' . $src, \FuerteWpDep\Carbon_Fields\URL . '/build/' . $context . '/' . $src . $suffix . '.css', $deps, \FuerteWpDep\Carbon_Fields\VERSION);
    }
    /**
    ...
    protected function enqueue_script($src, $deps = array())
    {
        $suffix = $this->get_assets_suffix();
        $context = $this->get_assets_context();
        wp_enqueue_script('carbon-fields-' . $src, \FuerteWpDep\Carbon_Fields\URL . '/build/' . $context . '/' . $src . $suffix . '.js', $deps, \FuerteWpDep\Carbon_Fields\VERSION);
    }
    /**
     * Enqueues the assets.
     *
    ...
    public function get_json_data()
    {
        ...
        foreach ($containers as $container) {
            ...
            if (\is_a($container, 'FuerteWpDep\\Carbon_Fields\\Container\\Block_Container', \true)) {
