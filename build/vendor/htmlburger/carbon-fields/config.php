...
namespace FuerteWpDep\Carbon_Fields;

# Define version constant
if (!\defined(__NAMESPACE__ . '\\VERSION')) {
    \define(__NAMESPACE__ . '\\VERSION', '3.6.0');
}
...
if (!\defined(__NAMESPACE__ . '\\URL')) {
    \define(__NAMESPACE__ . '\\URL', Carbon_Fields::directory_to_url(\FuerteWpDep\Carbon_Fields\DIR));
}
