 ...
 */
namespace FuerteWpDep\Composer;

use FuerteWpDep\Composer\Autoload\ClassLoader;
use FuerteWpDep\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('FuerteWpDep\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
