...
class Fuerte_Wp_Config
{
    ...
    private static function normalize_settings($settings)
    {
        return [
            ...
            'general' => [
                ...
                'autoupdate_core' => $settings['fuertewp_autoupdate_core'] ?? true,
                'autoupdate_plugins' => $settings['fuertewp_autoupdate_plugins'] ?? true,
                'autoupdate_themes' => $settings['fuertewp_autoupdate_themes'] ?? true,
                'autoupdate_translations' => $settings['fuertewp_autoupdate_translations'] ?? true,
            ...
            'restrictions' => [
                ...
                'restapi_disable_app_passwords' => $settings['fuertewp_restrictions_restapi_disable_app_passwords'] ?? true,
                'disable_xmlrpc' => $settings['fuertewp_restrictions_disable_xmlrpc'] ?? true,
                ...
                'disable_weak_passwords' => $settings['fuertewp_restrictions_disable_weak_passwords'] ?? true,
                ...
                'restrict_permalinks' => $settings['fuertewp_restrictions_restrict_permalinks'] ?? true,
                'restrict_acf' => $settings['fuertewp_restrictions_restrict_acf'] ?? true,
                'disable_theme_editor' => $settings['fuertewp_restrictions_disable_theme_editor'] ?? true,
                'disable_plugin_editor' => $settings['fuertewp_restrictions_disable_plugin_editor'] ?? true,
            ...
            'ip_lists' => [
                ...
                'registration_protect' => $settings['fuertewp_registration_protect'] ?? false,
            ],
            'login_security' => [
            ...
            'emails' => [
                ...
                'user_reset_their_password' => $settings['fuertewp_emails_user_reset_their_password'] ?? false,
                'user_confirm_personal_data_export_request' => $settings['fuertewp_emails_user_confirm_personal_data_export_request'] ?? false,
                'new_user_created' => $settings['fuertewp_emails_new_user_created'] ?? false,
                'network_new_site_created' => $settings['fuertewp_emails_network_new_site_created'] ?? false,
                'network_new_user_site_registered' => $settings['fuertewp_emails_network_new_user_site_registered'] ?? false,
                'network_new_site_activated' => $settings['fuertewp_emails_network_new_site_activated'] ?? false,
            ],
        ];
    }
    ...
    private static function load_from_legacy_database()
    {
        ...
        $config['general'] = [
            ...
            'autoupdate_core' => get_option('_fuertewp_autoupdate_core', true),
            'autoupdate_plugins' => get_option('_fuertewp_autoupdate_plugins', true),
            'autoupdate_themes' => get_option('_fuertewp_autoupdate_themes', true),
            'autoupdate_translations' => get_option('_fuertewp_autoupdate_translations', true),
        ...
        $config['emails'] = [
            ...
            'new_user_created' => get_option('_fuertewp_emails_new_user_created', false),
    ...
    public static function get_enforcer_config()
    {
        ...
        return [
            ...
            'fuertewp_autoupdate_core' => $config['general']['autoupdate_core'] ?? true,
            'fuertewp_autoupdate_plugins' => $config['general']['autoupdate_plugins'] ?? true,
            'fuertewp_autoupdate_themes' => $config['general']['autoupdate_themes'] ?? true,
            'fuertewp_autoupdate_translations' => $config['general']['autoupdate_translations'] ?? true,
            ...
            'fuertewp_emails_new_user_created' => $config['emails']['new_user_created'] ?? false,
