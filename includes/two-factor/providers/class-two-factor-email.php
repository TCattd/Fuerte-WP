...
class Two_Factor_Email extends Two_Factor_Provider
{
     ...
     * @var string
     */
    public const TOKEN_META_KEY = '_two_factor_email_token';
     ...
     * @var string
     */
    public const TOKEN_META_KEY_TIMESTAMP = '_two_factor_email_token_timestamp';
     ...
     * @var string
     */
    public const INPUT_NAME_RESEND_CODE = 'two-factor-email-code-resend';
    ...
    {
        add_action('two_factor_user_options_' . __CLASS__, [$this, 'user_options']);
        parent::__construct();
    }
     ...
     * @param int $user_id User ID.
     *
     * @return bool If user has a valid email token.
     */
     ...
     * @param int $user_id User ID.
     *
     * @return int|null Return `null` if the lifetime can't be measured.
     */
    ...
    public function user_token_ttl($user_id)
    {
         ...
         * @param int $user_id User ID.
         */
        $token_ttl = (int) apply_filters_deprecated('two_factor_token_ttl', [$token_ttl, $user_id], '0.11.0', 'two_factor_email_token_ttl');
     ...
     * @param int $user_id User ID.
     *
     * @return string|bool User token or `false` if no token found.
     */
