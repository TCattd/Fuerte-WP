...
class Two_Factor_Backup_Codes extends Two_Factor_Provider
{
     ...
     * @type string
     */
    public const BACKUP_CODES_META_KEY = '_two_factor_backup_codes';
    ...
    public function register_rest_routes()
    {
        register_rest_route(
            ...
            [
                ...
                'callback' => [$this, 'rest_generate_codes'],
    ...
    public function rest_generate_codes($request)
    {
        ...
        if ($request->get_param('enable_provider') && !Two_Factor_Core::enable_provider_for_user($user_id, 'Two_Factor_Backup_Codes')) {
            return new WP_Error('db_error', __('Unable to enable recovery codes for this user.', 'two-factor'), ['status' => 500]);
        }
