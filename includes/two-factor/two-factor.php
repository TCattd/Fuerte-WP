...
register_uninstall_hook(__FILE__, [Two_Factor_Core::class, 'uninstall']);
...
function two_factor_render_settings_page()
{
    ...
    if (class_exists('Two_Factor_Settings') && is_callable(['Two_Factor_Settings', 'render_settings_page'])) {
